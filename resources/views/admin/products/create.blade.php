                ...
                <div class="col-md-8">
                   @csrf                 
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="texturl" value="" placeholder="title">
                        <p class="small">http://localhost /<span id="url"></span></p>
                        <input type="hidden" name="slug" id="slug" value="">
                    </div>
                    <div class="form-group">
                        <label for="editor">Description</label>
                        <textarea name="discription" class="form-control" id="editor" cols="30" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <div class="row">
                              <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="0.00" id = "price" name="price" value="">
                                </div>
                              </div>
                              <div class="col-md-6">
                                ...
                                <div class="input-group mb-3">
                                  ...
                                  <input type="text" class="form-control" placeholder="0.00" id = "discount" name="discount" value = "">
                                </div>
                              </div>
                        </div>
                          ...
                          <div class="input-group my-3">
                            <div class="input-group-prepend">
                              <div class="input-group-text">
                                <input type="checkbox" id = "featuredPro" name = "featuredproduct" value = ""> 
                              </div>
                            </div>
